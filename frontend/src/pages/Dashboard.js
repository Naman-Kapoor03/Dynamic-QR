...
import {
  ...
  BarChart2, Zap, Activity, X, CircleDot, ZoomIn,
} from "lucide-react";
...
export default function Dashboard() {
  ...
  const [qrOpen, setQrOpen] = useState(false); // ← only new state
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-[1fr_296px] gap-6 items-start">
            ...
            <div className="flex flex-col gap-[18px]">
              ...
              >
                {/* ── clickable QR with zoom hint ── */}
                <div
                  className="qr-img-wrap bg-white rounded-xl p-3 inline-block mb-5
